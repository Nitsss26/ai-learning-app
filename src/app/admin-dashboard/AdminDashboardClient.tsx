...
export default function AdminDashboard() {
  ...
  const links = [
    ...
    },
    {
      ...
      href: "feedback",
      icon: (
        <IconMessageReportFilled className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Reports",
      href: "reports",
      icon: (
        <IconChartPie2Filled className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Finance",
    ...
    },
    {
      ...
      href: "logs",
      icon: (
        <IconTerminal2 className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Contact",
  ...
  const pages = {
    ...
    courses: <DemoDashboard />,
    blogs: <DemoDashboard />,
    feedback: <DemoDashboard />,
    reports: <DemoDashboard />,
    finances: <DemoDashboard />,
    logs: <DemoDashboard />,
    contact: <DemoDashboard />,
    settings: <DemoDashboard />,
  };
          ...
          <div className="flex flex-col gap-1">
            {links.map((link, idx) => (
              <SidebarLink
                ...
                className={`${
                  searchParams.get("page") === link.href
