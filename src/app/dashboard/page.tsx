...
export default function UserDashboard() {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (!mobile) {
        ...
        setSidebarOpen(false); // Sidebar closed on mobile by default
      }
    };
  ...
  return (
    <>
      ...
      {/* Hamburger button BELOW navbar (mobile only) */}
      ...
      <div className="pt-20 flex min-h-screen w-full bg-[#020b1a] text-white relative">
        {/* SIDEBAR - Desktop and Mobile versions are conditionally rendered */}
        {isMobile ? (
          // Mobile Sidebar
          <div
            className={cn(
